...
export function makeRoundSoapPrompt(params: RoundSoapPromptParams) {
  return [
    ...
    "- HARD SIZE LIMITS: headerLines <=4, subjectiveLines <=4, vitalSigns <=2, physicalExam <=3, labs <=6 panel objects, microbiology <=4, imaging <=4 studies, pathology <=3, assessmentPlan <=6 problems, orders <=6, tasks <=6, discharge <=4, warnings <=4, highlightHints <=8.",
