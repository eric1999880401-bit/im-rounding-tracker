...
export function makeRoundSoapPrompt(params: RoundSoapPromptParams) {
  return [
    ...
    "- objective.labs contains compact panel selections. Use CBC/DC, Chem/Renal, Liver/Coag, Infx/Perfusion, Urinalysis, ABG/VBG, Cardiac, or Other. Never emit one object per analyte.",
