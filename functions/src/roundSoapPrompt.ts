...
export function makeRoundSoapPrompt(params: RoundSoapPromptParams) {
  return [
    ...
    "- Keep CBC/DC on one line. When a current CBC is supplied, preserve WBC, Hb, and Plt together for orientation; add Neu/differential when clinically useful. Keep BUN/Cr/eGFR/electrolytes on Chem/Renal. CRP/PCT/lactate belong to Infx/Perfusion, not Chem/Renal.",
